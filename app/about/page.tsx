        ...
        <Container>
          <FadeIn>
            <div className="grid grid-cols-12 gap-x-4 gap-y-12 md:gap-x-8">
              <h2 className="col-span-12 font-h2 text-foreground">Small by design.</h2>
              <div className="col-span-12 md:col-span-3">
              ...
              <div className="col-span-12 md:col-span-9">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
                  <div className="flex flex-col gap-y-5">
                    ...
                    <p className="text-xs font-medium uppercase tracking-widest text-accent">Scale Strategist</p>
                  ...
                  <div className="flex flex-col gap-y-5">
                    ...
                    <p className="text-xs font-medium uppercase tracking-widest text-accent">Product & AI Operator</p>
                    <p className="text-muted text-sm leading-relaxed">
